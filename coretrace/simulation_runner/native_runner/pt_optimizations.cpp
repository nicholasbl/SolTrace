...
namespace SolTrace::NativeRunner
{
        ...
        glm::dvec3& reccm_helio)
    {
        ...
        if (AsPowerTower)
        {
            ...
            glm::dvec3 dum1(0.0, 0.0, 1.0);
            glm::dvec3 dum2;
            glm::dvec3 reccm_global;

            Data::TransformToReference(reccm,
                                       dum1,
                                       System->StageList[1]->Origin,
                                       System->StageList[1]->RLocToRef,
                                       reccm_global,
                                       dum2);

            // Transform to local (heliostat). reccm_helio is the x,y,z position
            // of the receiver centroid in heliostat stage coordinates.
            Data::TransformToLocal(reccm_global,
                                   dum1,
                                   System->StageList[0]->Origin,
                                   System->StageList[0]->RRefToLoc,
                                   reccm_helio,
                                   dum2);
        }
